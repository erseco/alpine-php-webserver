...
- `latest`, `3`, `3.22`, `3.22.1-1` ([Dockerfile](https://github.com/erseco/alpine-php-webserver/blob/3.22.1-1/Dockerfile))
...
| PHP8   | opcache_preload               | ""            | Specifies a PHP script to be compiled and executed at server start-up, improving performance. See [PHP Preloading](https://www.php.net/manual/en/opcache.configuration.php#ini.opcache.preload). Example: `/var/www/html/config/preload.php` |
